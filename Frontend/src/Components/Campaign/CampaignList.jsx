                    ...
                    {dummyCampaigns.map((campaign) => (
                        ...
                        >
                            ...
                            <div className="p-6 flex flex-col flex-grow">
                                <h3 className="text-4xl font-semibold text-green-500 mb-2">{campaign.title}</h3>
                                <p className="text-lg text-gray-300 mb-4 flex-grow">{campaign.tagline}</p>
                                ...
                                <div className="mt-4 flex justify-between items-center">
                                    ...
                                    <button onClick={() => handleCardClick(campaign.id)} className="bg-gradient-to-r from-green-500 to-green-700 text-white rounded-lg py-3 px-6 text-lg font-semibold shadow-lg cursor-pointer hover:bg-green-800 hover:shadow-xl transition-all">
                                        View Details
                                    </button>
                                </div>
                            </div>
