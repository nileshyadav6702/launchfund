    ...
    return (
      <nav className="bg-white shadow-md px-6 py-3 flex justify-between items-center fixed top-0 w-full z-50">
        ...
        <div className="hidden lg:flex items-center space-x-4">
          ...
          <a
            href="/start_campaign"
            className="border border-green-400 text-green-600 px-4 py-2 rounded-md hover:bg-green-400 hover:text-white transition-all duration-300 ease-in-out transform hover:scale-105 flex items-center gap-1 cursor-pointer"
          >
        ...
        <div
          className={`absolute top-14 left-0 w-full bg-white shadow-md flex flex-col items-center py-4 space-y-4 lg:hidden transition-transform origin-top ${
